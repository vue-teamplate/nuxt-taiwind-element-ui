          ...
          <div style="--aspect-ratio: 4/2">
            <div
              ...
              style="
                width: 100%;
                height: 100%;
                background-image: url(https://vova-public.s3.ap-southeast-1.amazonaws.com/courses/tai-chinh-gia-dinh/anh/tai_chinh_gia_dinh_thumbnail1.jpg);
              ...
              <div class="flex text-white flex-col md:flex-row">
                <div class="w-full md:w-2/5">
                  ...
                  >
                    ...
                    trẻ cần biết. Đặc biệt,
                  </p>
                </div>
                <div class="flex flex-col xs:flex-row xs:w-5/6 md:w-5/12">
                  <div class="flex justify-between w-full pt-3 md:pt-0">
                    <div class="w-5/12 text-center pt-1">
                      <p
                        class="font-normal text-xl xs:text-2xl pb-2 xs:pb-3 pt-0 leading-4"
                      >
                        0
                      </p>
...
.bg-course {
  ...
  background-image: linear-gradient(
    ...
    url(https://vova-public.s3.ap-southeast-1.amazonaws.com/courses/mang-bau-ko-au-lo/anh/trang_moon_thumbnail.jpg);
}
</style>
